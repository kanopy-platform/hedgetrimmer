...
func (j *ReplicationControllerHandler) Kind() string {
	return "ReplicationController"
}

func (j *ReplicationControllerHandler) Handle(ctx context.Context, req kadmission.Request) kadmission.Response {
